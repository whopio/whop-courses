...
export default async function AdminHome({ params, searchParams }: PageProps) {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 m-auto max-w-6xl pt-6">
      ...
      {courses.length === 0 ? (
        <div className="flex flex-col items-center gap-2 border-slate-200 border-2 rounded-xl p-8">
          <FontAwesomeIcon
            icon={faFileCirclePlus}
            size="3x"
            className="text-neutral-400"
          />
          <h3 className="font-bold size-lg">Create a Course</h3>
          <p className="text-center">
            Let’s get you started by creating a brand new course!
          </p>
          <div className="mt-2">
            <CreateCourseButton
              companyId={company.tag}
